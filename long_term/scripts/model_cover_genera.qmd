...
m_ccover_genus <- brm(
  ...
  + (1 | marine_area) + (1 | genus) + (1 | year:marine_area:genus),
...
```{r}
summary(m_ccover_genus)#Rhats ok, 1 div trans
pp_check(m_ccover_genus, ndraws = 100) # good

library(performance)

r2_bayes(m_ccover_genus)
  # Conditional R2: 0.889 (95% CI [0.876, 0.901])
  #    Marginal R2: 0.575 (95% CI [0.053, 0.774])
