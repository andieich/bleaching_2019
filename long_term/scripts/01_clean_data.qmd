...
```{r}
dat <- read_excel(
  here("long_term/data/raw/20230926MPAMooreaData_substrate.xlsx"),
...
substrate_ <- c("Mud", "Pavement", "Rubble", "Sand")

other <- c("Millepora", "Other", "Softcoral", "Other_anemone")
...
dat <- dat %>%
  mutate(
    benthic_group = case_when(
      substrate %in% corals ~ "coral",
