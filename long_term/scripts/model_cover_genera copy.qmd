...
calculate_genus_cover_ba <- function(data){
...
### Changes coral cover per genus outer reef
...
```{r}
m_gen1 <- brm(bf(mvbind(before, after) ~ year * marine_area * genus + (1|marine_area)),
                family = Beta(),
              ...
              threads = threading(2, static = T),
                file = here("long_term/models/m_gen1"))
  
m_gen2 <- brm(bf(mvbind(before, after) ~ year * marine_area * genus + (1|marine_area),
                   phi ~ year * marine_area * genus),
                family = Beta(),
                data = dat_genus_delta,
                init = 0,
                iter = 4000,
              ...
              threads = threading(2, static = T),
                seed = 123,
                backend = "cmdstanr",
                file = here("long_term/models/m_gen2"))


m_gen3 <- brm(bf(mvbind(before, after) ~ year * marine_area * genus + (1|marine_area),
                   phi ~ year * marine_area * genus + (1|marine_area)),
                family = Beta(),
                data = dat_genus_delta,
                init = 0,
                iter = 4000,
              ...
              threads = threading(2, static = T),
                seed = 123,
                backend = "cmdstanr",
                file = here("long_term/models/m_gen3"))


m_gen4 <- brm(bf(mvbind(before, after) ~ year * marine_area * genus + (1|marine_area),
                   phi ~ (1|marine_area)),
                family = Beta(),
                data = dat_genus_delta,
                init = 0,
              ...
              threads = threading(2, static = T),
                backend = "cmdstanr",
                file = here("long_term/models/m_gen4"))


m_gen5 <- brm(bf(mvbind(before, after) ~ year * marine_area * genus + (1|marine_area),
              ...
              threads = threading(2, static = T),
                backend = "cmdstanr",
                file = here("long_term/models/m_gen5"))

m_gen6 <- brm(bf(mvbind(before, after) ~ year * marine_area * genus + (1|marine_area),
                   phi ~ genus + (1|marine_area)),
                family = Beta(),
                data = dat_genus_delta,
                init = 0,
                iter = 4000,
              ...
              threads = threading(2, static = T),
                backend = "cmdstanr",
                file = here("long_term/models/m_gen6"))


m_gen7 <-brm(bf(mvbind(before, after) ~ year * marine_area * genus + (1|marine_area),
                   phi ~ year + genus + (1|marine_area)),
                family = Beta(),
                data = dat_genus_delta,
                init = 0,
                iter = 4000,
              ...
              threads = threading(2, static = T),
                backend = "cmdstanr",
                file = here("long_term/models/m_gen7"))


m_gen8 <-brm(bf(mvbind(before, after) ~ year * marine_area * genus + (1|marine_area),
                   phi ~ year * genus + (1|marine_area)),
                family = Beta(),
                data = dat_genus_delta,
                init = 0,
              ...
              threads = threading(2, static = T),
                backend = "cmdstanr",
                file = here("long_term/models/m_gen8"))

m_gen9 <-brm(bf(mvbind(before, after) ~ year * marine_area * genus + (1|marine_area),
                   phi ~ year + marine_area + genus + (1|marine_area)),
                family = Beta(),
                data = dat_genus_delta,
                init = 0,
              ...
              threads = threading(2, static = T),
                backend = "cmdstanr",
                file = here("long_term/models/m_gen9"))

m_gen10 <-brm(bf(mvbind(before, after) ~ year * marine_area * genus + (1|marine_area),
                   phi ~ year*marine_area + year*genus + (1|marine_area)),
                family = Beta(),
                data = dat_genus_delta,
                init = 0,
                iter = 4000,
              ...
              threads = threading(2, static = T),
                backend = "cmdstanr",
                file = here("long_term/models/m_gen10"))
```

```{r}
summary(m_gen1)
pp_check(m_gen1, resp = "after", ndraws = 100)
pp_check(m_gen1, resp = "before", ndraws = 100)
bayes_R2(m_gen1)
```
...
```{r}
summary(m_ccover8)
pp_check(m_ccover8, resp = "after", ndraws = 100)
pp_check(m_ccover8, resp = "before", ndraws = 100)
...
```{r}
summary(m_ccover9)
pp_check(m_ccover9, resp = "after", ndraws = 100)
pp_check(m_ccover9, resp = "before", ndraws = 100)
...
```{r}
summary(m_ccover10)
pp_check(m_ccover10, resp = "after", ndraws = 100)
pp_check(m_ccover10, resp = "before", ndraws = 100)
...
m_ccover8 <- add_criterion(m_ccover8, "loo", moment_match = TRUE)
m_ccover9 <- add_criterion(m_ccover9, "loo", moment_match = TRUE)
m_ccover10 <- add_criterion(m_ccover10, "loo", moment_match = TRUE)

loo_compare(m_ccover1, m_ccover2, m_ccover3, m_ccover4, m_ccover5, m_ccover6, m_ccover7,m_ccover8, m_ccover9, m_ccover10)
