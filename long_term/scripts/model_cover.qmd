...
Dump remaining genera unot into "Others", re-calculate cover
...
```{r}
summary(m_ccover_19)# 2 div trans, that  ESS good
pp_check(m_ccover_19, ndraws = 100)
bayes_R2(m_ccover_19)

summary(m_ccover_20) # 30 div trans, that  ESS good
pp_check(m_ccover_20, ndraws = 100)
bayes_R2(m_ccover_20)

summary(m_ccover_21)# 11 div trans, that  ESS good
pp_check(m_ccover_21, ndraws = 100)
bayes_R2(m_ccover_21)

summary(m_ccover_22) # 1 div trans, that  ESS good
